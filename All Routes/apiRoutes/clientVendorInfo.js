...
function getParentProducts(pName,vendorId,coverPhoto,res){
 ...
 router.post('/searchVendorProducts/:vendorId/:catId', function(req, res) {
    ...
    router.post('/getProductSizes/:vendorId/:catId', function(req, res) {
      ...
      router.post('/getProductColors/:vendorId/:catId', function(req, res) {
      ...
      router.post('/getProductTgs/:vendorId/:catId', function(req, res) {
